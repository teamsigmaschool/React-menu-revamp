  ...
  return (
    <>
        ...
        <div id="logo-container" className="d-flex flex-column align-items-center justify-content-center mb-3" >
          ...
          <h1 className="fw-bold fs-1">Uncle Haris Food Menu</h1>
        </div>
...
// To make sure it runs properly, make sure to: 
// npm install bootstrap react bootstrap
// import "bootstrap/dist/css/bootstrap.min.css"; for main.jsx or index.jsx file 
// and download the assets folder to get all the images used
